...
// тестовый класс загрузки файлов 
// по дефолту устанавливат типы валидных разширений файлов
// 1. проверяет разширение загружаемых файлов в зависимости
//    от валидности файлов формирует:
//    а). массивы с валидными и не валидными файлами
//    б). массив с загруженными файлами
//    в). масив с сохраненными файлами 
//    г). массив ошибок сохранения файлов
// 2. сохраняет файлы
